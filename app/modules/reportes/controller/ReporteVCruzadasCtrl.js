...
angular.module("App")
    .controller("ReporteVCruzadasCtrl", ['$scope',
        '$state',
        '$sessionStorage',
        '$rootScope',
        'ReportesServices',
        ...
        function ($scope,
            ...
            $scope.getAllSiniestros= function () {
                ...
                ReportesServices.getInfoVCruzadas($scope.filterCriteria).then(function (resp) {
            ...
            $scope.exportPdfReport = function(){
                ...
                ReportesServices.getCreateReporteVentasC(request)
                    .then(function(resp){
